...
public class SousCategorieController {
	...
	@ApiMethod(path = "souscategories/{idCategorie}/{idSousCategorie}/{newName}", httpMethod = ApiMethod.HttpMethod.PUT)
	public SousCategorie modifyID(@Named("idCategorie") String idCategorie,
			@Named("idSousCategorie") long idSousCategorie, @Named("newName") String newName) {

		return SousCategorieService.modifyById(idCategorie, idSousCategorie, newName);
	}

	@ApiMethod(path = "souscategories/{idCategorie}/{idSousCategorie}/", httpMethod = ApiMethod.HttpMethod.DELETE)
